...
public class ProductPrinter implements Printer<Product> {
    ...
    public String shortToStringVersion(Product prod) {
        ...
        returnValue = "◉ - [ID: " + prod.getID() + " | Name: " + prod.getName() + " | Unit price: " + prod.getUnitPrice() + "€ | "
                + quantity + " ]";
        return returnValue;
    }
    ...
    public String fullToStringVersion(Product prod) {
        ...
        String secondLine = String.format("%-271s",
                new String(
                        "| [ID: " + prod.getID() + " - Product name: " + prod.getName() + " - Unit price: "
                                + prod.getUnitPrice() + " - Availability: " + quantity + " ]"))
                + "|";
        String thirdLine = String.format("%-271s", new String("| Description: " + prod.getDescription())) + "|";
